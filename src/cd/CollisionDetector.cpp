...
namespace CD {
    bool CollisionDetector::isInVoxel(shared_ptr<Vector2D> voxel, shared_ptr<Motion> motion) {
    ...
    void CollisionDetector::putIntoMap(shared_ptr<RedBlackTree<shared_ptr<Vector2D>, shared_ptr<Vector<shared_ptr<Motion>>>>> voxelMap, shared_ptr<Vector2D> voxel, shared_ptr<Motion> motion) {
    ...
    void CollisionDetector::recurse(shared_ptr<RedBlackTree<shared_ptr<Vector2D>, shared_ptr<Vector<shared_ptr<Motion>>>>> voxelMap, shared_ptr<RedBlackTree<shared_ptr<Vector2D>, 
    ...
    shared_ptr<Vector<shared_ptr<Vector<shared_ptr<Motion>>>>> CollisionDetector::reduceCollisionSet(shared_ptr<Vector<shared_ptr<Motion>>> motions) {
    ...
    shared_ptr<Vector2D> CollisionDetector::voxelHash(shared_ptr<Vector3D> position) {
    ...
    void CollisionDetector::drawMotionOnVoxelMap(shared_ptr<RedBlackTree<shared_ptr<Vector2D>, shared_ptr<Vector<shared_ptr<Motion>>>>> voxelMap, shared_ptr<Motion> motion) {
    ...
    shared_ptr<Vector<shared_ptr<Collision>>> CollisionDetector::handleNewFrame(shared_ptr<Vector<shared_ptr<Aircraft>>> frame) {
